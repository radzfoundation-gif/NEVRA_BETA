...
content = content.replace(
  ...
  "className=\"absolute bottom-full right-0 sm:right-0 sm:-translate-x-0 mb-2 w-[85vw] max-w-[280px] sm:w-[260px] bg-white border border-stone-200 shadow-xl rounded-[18px] overflow-hidden flex flex-col z-[100] origin-bottom-right sm:origin-bottom-right\""
);
...
pContent = pContent.replace(
  ...
  "className=\"absolute bottom-full right-0 md:right-0 mb-2 w-[85vw] max-w-[224px] sm:w-56 bg-[#1a1a1a] border border-white/10 rounded-xl shadow-xl overflow-hidden z-50 backdrop-blur-xl origin-bottom-right\""
);
