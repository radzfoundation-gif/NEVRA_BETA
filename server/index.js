...
if (process.env.VERCEL !== '1' && !process.env.VERCEL_ENV) {
  ...
  // =====================================================
  // CLEANED: Duplicate payment endpoints removed (Lines 4550+)
  // Active payment logic is located at lines ~1388-1500
  // =====================================================

  // =====================================================
  // CLEANED: Duplicate payment and status endpoints removed.
  // Active logic is at lines ~1388-1550.
  // =====================================================
