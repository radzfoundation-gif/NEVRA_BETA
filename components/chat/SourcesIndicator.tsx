...
export const SourcesIndicator = ({ sources }: { sources: SearchResult[] }) => {
                    ...
                    {sources.map((source, idx) => {
                        ...
                        return (
                            <a
                                ...
                                className="flex flex-col gap-1 p-3 rounded-xl bg-white hover:bg-zinc-50 border border-zinc-200/50 hover:border-zinc-300 transition-all text-left group/card shadow-sm hover:shadow-md"
                            >
                                ...
                                <div className="flex items-center gap-1.5 text-[10px] text-zinc-500 mt-auto pt-1">
                                    <div className="w-3.5 h-3.5 rounded-full bg-zinc-100 flex items-center justify-center shrink-0">
