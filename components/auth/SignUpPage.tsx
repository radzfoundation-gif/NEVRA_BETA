            ...
            <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 flex items-center justify-center p-4">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-zinc-500 mb-6">
                        Kami telah mengirim link konfirmasi ke <span className="font-medium text-zinc-900">{email}</span>
                    </p>
                    <Link
                        to="/sign-in"
                        className="inline-block px-8 py-3 bg-gradient-to-r from-amber-400 to-yellow-500 text-zinc-900 rounded-full font-semibold hover:shadow-lg transition-all duration-300"
                    >
                        Ke Halaman Login
                    </Link>
                </div>
                    ...
                    <div className="w-full h-full rounded-[24px] overflow-hidden relative bg-gradient-to-br from-amber-100 to-yellow-100">
                        ...
                        <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-zinc-900">Welcome to Nevra</p>
                                    <p className="text-xs text-zinc-500">Your AI Learning Partner</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-24 left-8 right-8 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-zinc-900">Join 10,000+ learners</p>
                                    <p className="text-xs text-zinc-500">Start learning today</p>
                                </div>
                            </div>
                        </div>
