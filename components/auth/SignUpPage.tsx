            ...
            <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <p className="text-zinc-500 mb-8 leading-relaxed">
                        We've sent a confirmation link to <span className="font-semibold text-zinc-900">{email}</span>.
            ...
            >
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-zinc-100 p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-zinc-500 mb-6">Start your journey with Noir AI today</p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={true}
                        className="w-full mb-6 flex items-center justify-center gap-3 px-6 py-3 bg-zinc-50 border border-zinc-200 rounded-xl transition-all duration-200 shadow-sm opacity-60 cursor-not-allowed"
                    >
                        ...
                        <span className="font-medium text-zinc-400 italic">Google Sign Up Under Maintenance</span>
                    </button>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white text-zinc-400">or register with email</span>
                        </div>
                    </div>
