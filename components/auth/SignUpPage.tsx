            ...
            >
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-zinc-100 p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-zinc-500 mb-6">Start your journey with UseGlass AI today</p>
                    </div>
                    ...
                    >
                        ...
                        <span className="font-medium text-zinc-700">Sign up with Google</span>
                    </button>
                ...
                <div className="mt-8 text-center">
                    <p className="text-xs text-zinc-400">
                        Protected by reCAPTCHA and Subject to the UseGlass AI{' '}
