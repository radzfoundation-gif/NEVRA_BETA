            ...
            {isLoaded && isSignedIn && (
              <>
                ...
                <div className="relative">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 sm:right-0 top-full mt-2 w-[70vw] max-w-[192px] sm:w-48 bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-zinc-200 dark:border-zinc-800 p-2 z-50 origin-top-right">
